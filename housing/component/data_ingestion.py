...
class DataIngestion:
    ...
    def download_housing_data(self,) ->str :
        try:
           ...
           logging.info(f"Downloading file:[{download_url}] into:[{tgz_file_path}]")
    ...
    def split_data_as_train_test(self)-> DataIngestionArtifact:
        try:
            raw_data_dir = self.data_ingestion_config.raw_date_dir
    ...
    def initiate_data_ingestion(self)->DataIngestionArtifact:
        try:
            tgz_file_path = self.download_housing_dataz_file_path()
